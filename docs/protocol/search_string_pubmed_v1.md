...
4. Translate to other databases (Embase, CINAHL, IEEE Xplore, ACM Digital Library) per Issue #22 — syntax differs (Emtree vs MeSH, field tag conventions). Use Kumar et al. (2021), Gu et al. (2020/2023), Nayebi et al. (2022), and Clough et al. (2019) as concrete retrievability test cases for the ACM Digital Library / IEEE Xplore translations, since none are indexed in MEDLINE.
